...
注：原 Win+H 的功能是 Windows 自带听写，安装本插件后会变成 Win+Shift+H

<!-- 模块帮助文件名：插件-OneNote剪贴板收集器.ahk-->
### OneNote剪贴板收集器模块##### OneNote 剪贴板收集插件
...
### 合并右Ctrl与Menu键模块专治各种（Surface 的 右 Ctrl 键）残破键盘，合并 Menu与 右Ctrl键，Menu当Ctrl用 或者 Ctrl当Menu用都可以
...
<!-- 模块帮助文件名：插件-媒体键.ahk-->
### 媒体键模块| 模式 | 媒体键模块   | 说明 （这个模块基本还是半成品。。欢迎push） |
| - | :-: | - |
| CapslockX | F5   | 暂停播放 |
| CapslockX | F6   | 上一首 |
| CapslockX | F7   | 下一首 |
...
<!-- 模块帮助文件名：插件-搜索键.ahk-->
### 搜索键模块| 模式 | 搜索键模块   | 说明 （这个模块基本还是半成品。。欢迎push） |
| - | :-: | - |
| CapslockX | g    | 用 google 搜索当前选择或鼠标所指的词 |

<!-- 模块帮助文件名：插件-编辑增强.ahk-->
### 编辑增强模块| 模式 | Edit模块   | 说明 （欢迎push）|
| - | :-: | - |
